...
var jgivenURL = 'http://central.maven.org/maven2/com/tngtech/jgiven/jgiven-html5-report/' + jGivenVersion + '/jgiven-html5-report-' + jGivenVersion + '.jar';

console.log('Downloading JGiven ' + jGivenVersion);

var file = fs.createWriteStream(jgivenFile);
// eslint-disable-next-line flowtype/require-parameter-type
http.get(jgivenURL, function (response/*: any*/) {
