...
In order to use state sharing, you have to include the following babel transform plugins in your babel configuration.
...
Note that you are not forced to use this as your *.babelrc* production configuration.
