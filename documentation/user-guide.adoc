...
In order to use state sharing with decorators, you have to include the following babel transform plugins in your babel configuration.
...
You will need to have a promise implementation (a native or polyfilled one) and including the https://github.com/facebook/regenerator[Regenerator runtime]

If you use Babel directly with your test runner, Babel already includes polyfills. If not ensure they are included.
